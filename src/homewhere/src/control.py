...
class Control:
    ...
    #     left_turn = [-50, -50, 50, 50]
    #     right_turn = [50, 50, -50, -50]
    ...
    def set_velocity(self, vel):
        ...
        # self.front_left_velocity.angular.z = vel[0]
        # self.front_right_velocity.angular.z = vel[1]
        # self.back_left_velocity.angular.z = vel[2]
        # self.back_right_velocity.angular.z = vel[3]
        self.front_left_velocity.linear.x = vel[0]
        self.front_right_velocity.linear.x = vel[1]
        self.back_left_velocity.linear.x = vel[2]
        self.back_right_velocity.linear.x = vel[3]
